...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  static const VerificationMeta _documentUrlsMeta =
      const VerificationMeta('documentUrls');
  @override
  late final GeneratedColumn<String> documentUrls = GeneratedColumn<String>(
      'document_urls', aliasedName, true,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant(null));
  ...
  VerificationContext validateIntegrity(Insertable<Product> instance,
    ...
    if (data.containsKey('image_urls')) {
      context.handle(
          _imageUrlsMeta,
          imageUrls.isAcceptableOrUnknown(
              data['image_urls']!, _imageUrlsMeta));
    }
    if (data.containsKey('document_urls')) {
      context.handle(
          _documentUrlsMeta,
          documentUrls.isAcceptableOrUnknown(
              data['document_urls']!, _documentUrlsMeta));
    }
  ...
  Product map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Product(
      ...
      documentUrls: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}document_urls']),
...
class Product extends DataClass implements Insertable<Product> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || imageUrls != null) {
      map['image_urls'] =
          Variable<String>(const ListConverter().toSql(imageUrls!));
    }
    if (!nullToAbsent || documentUrls != null) {
      map['document_urls'] =
          Variable<String>(const ListConverter().toSql(documentUrls!));
    }
...
class ProductsCompanion extends UpdateCompanion<Product> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (imageUrls.present) {
      map['image_urls'] =
          Variable<String>(const ListConverter().toSql(imageUrls.value!));
    }
    if (documentUrls.present) {
      map['document_urls'] =
          Variable<String>(const ListConverter().toSql(documentUrls.value!));
    }
...
class Supplier extends DataClass implements Insertable<Supplier> {
  ...
  Supplier copyWith(
      ...
      Supplier(
        ...
        name: name ?? this.name,
        contactName:
            contactName.present ? contactName.value : this.contactName,
...
class User extends DataClass implements Insertable<User> {
  ...
  User copyWith({String? id, String? email, String? password, int? role}) =>
      User(
        id: id ?? this.id,
        email: email ?? this.email,
